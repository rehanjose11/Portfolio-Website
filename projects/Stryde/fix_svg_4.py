...
replacement = """<!-- Floor Plan SVG Diagram -->
            ...
            <div class="fp-container">
                <svg class="fp-svg" viewBox="0 0 650 700" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <!-- The Food Zone spans entirely down the left side -->
                    ...
                    <!-- BUILDING WALLS -->
                    <!-- The building is a pure 38x48m footprint rectangle with only the top 3m entrance piece missing -->
                    <path class="fp-wall" d="M 295 100 L 100 100 L 100 580 L 520 580 L 520 100 L 325 100" />
                    
                    <!-- Inner Separators -->
                    <!-- Lobby dashed divider -->
                    <line x1="100" y1="170" x2="520" y2="170" stroke-dasharray="6,4" stroke-width="1.5" stroke="#6a6a6a" fill="none"/>
                    
                    <!-- Theatre Box (Inner borders) -->
                    <rect x="170" y="170" width="280" height="340" class="fp-line"/>
                    <!-- Extending Food Zone border down to the bottom wall -->
                    ...
                    <!-- Text blocks inserted around the lines -->
                    <text x="310" y="340" class="lbl-l" fill="#d63a2a">THEATRE</text>
                    <text x="310" y="360" class="fp-dim-text" font-size="10">28m × 34m</text>

                    <line x1="180" y1="380" x2="440" y2="380" stroke="#3d1c16" stroke-width="1.5"/>
                    <line x1="180" y1="410" x2="440" y2="410" stroke="#3d1c16" stroke-width="1.5"/>
                    <line x1="180" y1="440" x2="440" y2="440" stroke="#3d1c16" stroke-width="1.5"/>
                    
                    <!-- Entrance opening embedded in the second to last line -->
                    <line x1="180" y1="470" x2="270" y2="470" stroke="#3d1c16" stroke-width="1.5"/>
                    <text x="310" y="473" class="lbl-s" fill="#6a6a6a">ENTRANCE</text>
                    <line x1="350" y1="470" x2="440" y2="470" stroke="#3d1c16" stroke-width="1.5"/>

                    <line x1="180" y1="500" x2="440" y2="500" stroke="#3d1c16" stroke-width="1.5"/>
                    ...
                    <!-- Dash continuing exactly from bottom-right outer wall corner -->
                    <line x1="520" y1="580" x2="546" y2="580" class="fp-dashed"/>

                    <!-- Bottom Section (24m Dimension exactly bounded) -->
