...
replacement = """<!-- Floor Plan SVG Diagram -->
            <style>
                ...
                .fp-dashed { stroke-dasharray: 6,4; }
                ...
                .lbl-s { font-family: 'DM Mono', monospace; font-size: 8px; letter-spacing: 0.1em; text-anchor: middle; }
            ...
            <div class="fp-container">
                <svg class="fp-svg" viewBox="0 0 650 700" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <!-- BUILDING WALLS -->
                    <!-- Outer Boundary -->
                    <path class="fp-wall" d="M 295 100 L 100 100 L 100 580 L 210 580" />
                    <path class="fp-wall" d="M 300 580 L 340 580 L 340 510 L 520 510 L 520 100 L 325 100" />
                    
                    <!-- Inner Separators -->
                    <line x1="100" y1="170" x2="520" y2="170" class="fp-wall fp-dashed" stroke-width="1.5" stroke="#f0ede8"/>
                    ...
                    <!-- Ticket Counter -->
                    <rect x="450" y="100" width="70" height="40" class="fp-line" stroke="#6a6a6a"/>
                    <text x="485" y="117" class="lbl-s" fill="#6a6a6a">TICKET</text>
                    <text x="485" y="129" class="lbl-s" fill="#6a6a6a">COUNTER</text>
                    ...
                    <text x="255" y="570" class="lbl-s" fill="#6a6a6a" text-anchor="middle">ENTRANCE</text>
                    ...
                    <line x1="340" y1="580" x2="550" y2="580" class="fp-dim-line fp-dashed"/>
