...
replacement = """<!-- Floor Plan SVG Diagram -->
            ...
            <div class="fp-container">
                <svg class="fp-svg" viewBox="0 0 650 700" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <!-- Ticket Counter (Explicitly placed so it has clearance from outer white stroke) -->
                    <rect x="450" y="105" width="65" height="35" class="fp-line"/>
                    <text x="482.5" y="122" class="lbl-s" fill="#6a6a6a">TICKET</text>
                    <text x="482.5" y="134" class="lbl-s" fill="#6a6a6a">COUNTER</text>
                    ...
                    <!-- ENTRANCE precisely aligned centrally underneath the THEATRE block -->
                    <text x="310" y="570" class="lbl-s" fill="#6a6a6a">ENTRANCE</text>
                    ...
                    <line x1="100" y1="65" x2="100" y2="100" class="fp-dashed"/>
                    <line x1="295" y1="65" x2="295" y2="100" class="fp-dashed"/>
                    <line x1="325" y1="65" x2="325" y2="100" class="fp-dashed"/>
                    <line x1="520" y1="65" x2="520" y2="100" class="fp-dashed"/>
                    ...
                    <text x="482.5" y="155" class="fp-dim-text" font-size="9">7m</text>
                    <line x1="450" y1="160" x2="515" y2="160" class="fp-dim-line" stroke-width="0.5"/>
                    <line x1="450" y1="157" x2="450" y2="163" class="fp-dim-line"/>
                    <line x1="515" y1="157" x2="515" y2="163" class="fp-dim-line"/>
